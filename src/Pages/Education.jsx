  ...
  return (
    <div className='mx-auto w-11/12 mb-10 '>
      ...
      <div className='flex justify-center items-center mt-10 '>
        <img src={cmrimage} alt='cmrimage' width={1000} className='rounded-md' />
      </div>
      <div className='flex flex-col md:w-9/12  mx-auto text-start text-xl space-y-10 mt-10 md:translate-x-5'>
